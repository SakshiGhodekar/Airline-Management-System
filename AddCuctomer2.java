...
public class AddCuctomer2 extends JFrame implements ActionListener
{
...
try
{
s.executeUpdate("insert into pasenger values('"+name+"','"+nationality+"','"+address+"','"+aadhar+"','"+phone+"','"+gender+"')");
