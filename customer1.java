...
try
{
st.executeUpdate("insert into pasenger1 values('"+name+"','"+nationality+"','"+address+"','"+aadhar+"','"+phone+"','"+gender+"')");
//st.executeUpdate("insert into book values('"+aadhar+"')");
